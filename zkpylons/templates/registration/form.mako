...
%       elif category.name == "Partners' Programme":
          <p class="note"><span class="mandatory">#</span>If your partner will be participating in the programme, then this field is required so that our Partners' Programme manager can contact them.</p>
